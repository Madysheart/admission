...
import 'package:admission/Login/Staff/intrested/intform.dart';
...
class _IntrestedState extends State<Intrested> {
  ...
  Widget build(BuildContext context) { 
    ...
    return SafeArea(child: Scaffold(appBar: AppBar(
      ...
      title: Text("Intrested",style: TextStyle(color: Colors.white,fontSize: 18),),
                                      ...
                                      child: Row(children: [
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            Navigator.push(context, MaterialPageRoute(builder: (context)=>intform()));
                                            },
                                          ),
                                        ),
