...
class notsubform extends StatefulWidget {
  const notsubform({super.key});

  @override
  State<notsubform> createState() => _notsubformState();
}

class _notsubformState extends State<notsubform> {
              ...
              child: Padding(
                ...
                Row(
                        children: [
                          ...
                          TextButton(onPressed: (){}, child: Text("Document Not submitted",style: TextStyle(color: Colors.orange),))
                        ],
                      ),
                      SizedBox(
                        height: 20,
