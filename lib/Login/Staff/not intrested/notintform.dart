...
class notintform extends StatefulWidget {
  const notintform({super.key});

  @override
  State<notintform> createState() => _notintformState();
}

class _notintformState extends State<notintform> {
              ...
              child: Padding(
                ...
                Row(
                        children: [
                          ...
                          TextButton(onPressed: (){}, child: Text("Not Intrested",style: TextStyle(color: Colors.red),))
                        ],
                      ),
                      SizedBox(
                        height: 20,
                                                ...
                                                SizedBox(
                                                 ...
                                                 Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                      'Student said that he is  ',maxLines: null,
                                                      style:
                                                          TextStyle(fontSize: 14),
                                                    ),
