...
class ogform extends StatefulWidget {
  const ogform({super.key});

  @override
  State<ogform> createState() => _ogformState();
}

class _ogformState extends State<ogform> {
              ...
              child: Padding(
                ...
                Row(
                        children: [
                          ...
                          TextButton(onPressed: (){}, child: Text("Document Submitted",style: TextStyle(color: Colors.green),))
                        ],
                      ),
                      SizedBox(
                        height: 20,
