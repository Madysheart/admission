...
class Allform extends StatefulWidget {
  const Allform({super.key});

  @override
  State<Allform> createState() => _AllformState();
}

class _AllformState extends State<Allform> {
              ...
              child: Padding(
                ...
                Row(
                        children: [
                          ...
                          TextButton(onPressed: (){}, child: Text("Not paid",style: TextStyle(color: Colors.red),))
                        ],
                      ),
                      SizedBox(
                        height: 20,
