...
class allist extends StatefulWidget {
  const allist({super.key});

  @override
  State<allist> createState() => _allistState();
}

class _allistState extends State<allist> {
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
      ...
      title: Text("Contacts",style: TextStyle(color: Colors.white,fontSize: 18),),
                                      ...
                                      child: Row(children: [
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            Navigator.push(context, MaterialPageRoute(builder: (context)=>Allform()));
                                            },
                                          ),
                                        ),
