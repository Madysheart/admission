...
class partialform extends StatefulWidget {
  const partialform({super.key});

  @override
  State<partialform> createState() => _partialformState();
}

class _partialformState extends State<partialform> {
                ...
                // });
                      ...
                      Row(
                        children: [
                          ...
                          TextButton(onPressed: (){}, child: Text("Partially Paid",style: TextStyle(color: Colors.orange),))
                        ],
                      ),
                        SizedBox(
                  height: 20,
